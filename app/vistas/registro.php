...
<body style="height: 100vh;">
    <main class="d-flex flex-column justify-content-center align-items-center h-100">
        ...
        <div class="m-auto d-flex flex-column w-25 bg-dark text-white text-center rounded rounded-4 registro">
            <form action="index.php?accion=registrar" method="POST" class="mt-4">
                <h1>Registro</h1>
                <div class="row mb-3 m-auto">
                    <label for="inputNombre3" class="col-sm-2 col-form-label m-auto">Nombre:</label><br>
                    <div class="col-sm-10 w-100">
                        <input type="text" name="nombre" class="form-control" id="inputNombre3" placeholder="Introduce tu nombre">
                    </div>
                </div>
                <div class="row mb-3 m-auto">
            ...
            <form method="GET">
                <div class="row m-auto">
                    <div class="col-sm-10 w-100">
                        <button type="reset" class="btn btn-danger w-100 mb-4" onclick="location.href='index.php?accion=inicio'">Volver atrás</button>
                    </div>
                </div>
            </form>
        </div>
